 ...
 *
 * $Id: doom3.php,v 1.9 2007/11/08 18:01:04 tombuskens Exp $  
 */
...
class GameQ_Protocol_doom3 extends GameQ_Protocol
{
    public function getinfo()
    {
        ...
        // Quakewars has a longer header
        $qw = (strlen($this->p->readString()) >= 8);
        ...
        // Some extra quakewars variables
        $version = (float) $this->r->get('version');
        if ($version >= 10.0) {
